...
-->
# Cookie Presence Decision Authentication Node

A simple authentication node for ForgeRock's [Identity Platform][forgerock_platform] 5.5 and above. This node checks if a cookie of the configured name is sent in with the authentication request.
